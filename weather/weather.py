...
def main():
    ...
    parser.add_argument('-f', action="store_true", dest='fahrenheit', default=True,
                        help='Temp in Fahrenheit (default: False)')
    parser.add_argument('-z', action="store", dest="zipcode", default='97206',
    ...
    parser.add_argument('-p', action="store_true", dest='use_proxy', default=False,
                        help='Use proxy')
    ...
    if args.use_proxy:
        proxy = urllib2.ProxyHandler({'http': 'www-proxy.us.oracle.com:80'})
